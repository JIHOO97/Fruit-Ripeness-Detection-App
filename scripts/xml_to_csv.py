...
def xml_to_csv(path):
    ...
    for xml_file in glob.glob(path + "/*.xml"):
        ...
        for member in root.findall("object"):
            ...
            rootFileName = root.find("filename").text
            if 'obj_train_data' in rootFileName:
              rootFileName = rootFileName[15:]
              if 'obj_train_data' in rootFileName:
                rootFileName = rootFileName[15:]
            ...
            value = (
                ...
                member[0].text,
                int(int(float(member[2][0].text))),
                int(int(float(member[2][1].text))),
                int(int(float(member[2][2].text))),
                int(int(float(member[2][3].text))),
            )
